...
This repository contains init containers and GHA workflows to automatically release new Kubernetes Agent Operator agent init containers when a new version of a language agent becomes available.
